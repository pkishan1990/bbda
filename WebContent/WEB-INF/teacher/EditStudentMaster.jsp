...
<script>
	window.onload = function() {
		...
		var arr = date.split("-");
		if(date.search("-") == -1){}
		else{$("#dateupto").val(arr[2]+"/"+arr[1]+"/"+arr[0]);}
		
		var gender = "${studentmasterCommand.gender}";
		var subj="";
		if(gender.trim()==="boy"){
		
			$("#genderboy").prop("checked", true);
		}else{
			$("#gendergirl").prop("checked", true);
		}
		subj="${studentmasterCommand.english}";
		if(subj.trim()==="1"){
			
			$("#english").prop("checked", true);
		}
		subj="${studentmasterCommand.socialscience}";
		if(subj.trim()==="1"){
			
			$("#socialscience").prop("checked", true);
		}
		subj="${studentmasterCommand.maths}";
		if(subj.trim()==="1"){
			
			$("#maths").prop("checked", true);
		}
		subj="${studentmasterCommand.science}";
		if(subj.trim()==="1"){
			
			$("#science").prop("checked", true);
		}
		subj="${studentmasterCommand.sanskrit}";
		if(subj.trim()==="1"){
			
			$("#sanskrit").prop("checked", true);
		}
		subj="${studentmasterCommand.gujarati}";
		if(subj.trim()==="1"){
		...
		if(subj.trim()==="1"){
			...
			$("#gijarati").prop("checked", true);
		}
		subj="${studentmasterCommand.computer}";
		if(subj.trim()==="1"){
		...
		<div class="page-content-wrapper ">
			...
			<div class="content ">
				...
				<div class="container-fluid container-fixed-lg">
					<form:form role="form" action="UpdateStudentInfo.htm" id="studentForm"
															...
															<div class="panel-body">
																	...
																	<div class="row">
																		...
																		<div class="col-sm-6">
																			<div class="form-group">
																				<label>Batch</label> 
																				<form:input path="batch" class="form-control" maxlength="10" required="true"/>
																			</div>
																		</div>
																	</div>
																	<div class="row">
